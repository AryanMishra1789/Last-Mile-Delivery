...
function createOrder() {
  ...
  // Hardcoded only for static-hosting user experience because the backend is not hosted.
  // The proper configurable zone and rate-card logic is implemented in app/services.py.
